...
struct CompletedBooksView: View {
    ...
    private func filterAndSortBooks() {
        ...
        case .completionDate:
            filtered.sort { sortAscending ? $0.completionDate < $1.completionDate : $0.completionDate > $1.completionDate }
        }
    ...
    var body: some View {
        ...
        .overlay(
            Rectangle()
                .fill(
                    LinearGradient(
                        colors: [Color(hex: "11998e").opacity(0.08), Color(hex: "38ef7d").opacity(0.08)],
                        startPoint: .leading,
                        endPoint: .trailing
                    )
                )
